...
selected_cols <- normalized_mobileTrain[, cnumeric_vars <- c("battery_power","clock_speed", "fc", "int_memory", "m_dep",	"mobile_wt", "n_cores","pc", "px_height",	"px_width", "ram", "sc_h", "sc_w", "talk_time")]
...
filtered_mobileTrain$price_numeric <- NULL
...
cor_matrix <- cor(filtered_mobileTrain[, numeric_vars])
